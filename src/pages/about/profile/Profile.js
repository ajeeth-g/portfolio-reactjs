      ...
      <div className="profile__right">
        ...
        <div className="profile__right-right ">
          ...
          <p>
            ...
            various landing pages, and CMS sites. Some of my work exposed me to
            learn new languages and frameworks such as Ruby on Rails, Elixir,
            and ReactJS. I see this as my advantage in designing feasible
            solutions and communicating ideas to engineers. I have since focused
            on design. I have held positions in various industries such as
            banking, advertising, and startups.
          </p>
          <p>
            Here are some of the companies and brands I have worked with: Lonely
            Planet, Simmons & Simmons, OP Games, Toyota Philippines, Mashup
            Garage, Eastwest Banking Corporation, PAREF Southridge School,
            IdeasXMachina, and Lorenzana Food Corp.
          </p>
